      ...
      <section className="relative pt-20 pb-20 md:pt-32 md:pb-32 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            We work with the best tools in the modern data stack ecosystem to
            build scalable, future-proof solutions for our clients.
          </p>
              ...
              <Card className="h-full border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardFooter className="border-t border-slate-100 pt-6 bg-slate-50/50">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <Button
                      variant="ghost"
                      className="text-primary hover:text-primary/80 p-0 hover:bg-transparent group"
                      asChild
                    >
                      <a
                        href={partner.link}
