    ...
    <div className="w-full bg-slate-50 min-h-screen">
      ...
      <section className="relative pt-32 pb-32 md:pt-48 md:pb-40 overflow-hidden bg-slate-950">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mx-auto leading-relaxed text-balance">
             But couldn&apos;t find, afford, or manage. <span className="text-slate-500">CodePlaced isn&apos;t an agency. We are a Fractional Growth Team. We plug into your EdTech operations, audit your funnel, and fix the leaks.</span>
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-4">
                Most EdTechs burn cash on ads because they trust dashboard metrics. We don&apos;t. We trust bank data, CRM logs, and enrollment numbers. If it didn&apos;t result in a student in a classroom, it&apos;s vanity.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-lg overflow-hidden p-8">
              <div className="mb-4">
                <h3 className="text-2xl font-bold text-slate-900">Manya Tyagi</h3>
                <p className="text-primary font-medium">Co-Founder — Analytics & Media</p>
              </div>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Ex-Annalect Omnicom. 5+ years in media analytics, SQL, Power BI,
                and Tableau. Leads every client engagement at CodePlaced — auditing ad
                accounts, finding where money is being wasted, and making sure every
                dashboard reflects reality.
              </p>
            </div>
            <p className="mt-6 text-slate-500 italic text-sm">
              Manya personally handles every audit, every call, and every dashboard we deliver.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-8">Why We Started CodePlaced</h2>
          <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
            <p>
              We kept seeing the same problem.
            </p>
            <p>
              EdTech founders in India were spending lakhs on Facebook and Google every
              month. Their counselors were talking to hundreds of leads. Enrollments
              were happening. But nobody could tell you which ad drove which enrollment.
            </p>
            <p>
              The data existed — in the ad account, in the CRM, in the payment gateway.
              It just lived in three different places and nobody had connected them.
            </p>
            <p>
              We built the system that connects them. First for one company. Now we are
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            We will audit your active ads for free and show you exactly what
            is broken. No commitment.
          </p>
          <Button
            asChild
            size="lg"
